...
_LAZY_EXPORTS: dict[str, str] = {
    ...
    "COMMERCIAL_DOMAIN_SCHEMA_VERSION": "domain_models",
    "CommercialCheck": "domain_models",
    "CommercialBlocker": "domain_models",
    "CommercialArtifactReference": "domain_models",
    "CommercialManualAction": "domain_models",
    "COMMERCIAL_VALIDATION_SCHEMA_VERSION": "validation",
    "validate_required_keys": "validation",
    "validate_no_url_path": "validation",
    "validate_local_path_string": "validation",
    "validate_existing_file": "validation",
    "validate_existing_dir": "validation",
    "validate_no_sensitive_metadata": "validation",
    "validate_manual_only_flags": "validation",
    "validate_path_containment": "validation",
    "load_json_object": "validation",
    "COMMERCIAL_MANIFEST_TOOLS_SCHEMA_VERSION": "manifest_tools",
    "stable_json_dumps": "manifest_tools",
    "write_stable_json": "manifest_tools",
    "sha256_text": "manifest_tools",
    "sha256_file": "manifest_tools",
