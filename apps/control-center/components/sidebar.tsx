...
export const NAV_SECTIONS: NavSection[] = [
  ...
  { id: "operator-read-surface", label: "Operator Read Surface", icon: "ORS", hint: "Stage 7.4 mock" },
  { id: "operator-dry-run", label: "Operator Dry Run", icon: "DR", hint: "Cohort 9B preview" },
