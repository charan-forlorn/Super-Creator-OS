...
const LIVE_PAYLOAD = {
  ...
  approval_summary: { available: true, status: "AVAILABLE_EMPTY", data: { approval_count: 0, audit_record_count: 8 }, reason_code: "READ_SOURCE_EMPTY", observed_at: "2026-07-16T01:02:03Z" },
  ...
  evidence_summary: { available: true, status: "AVAILABLE_WITH_DATA", data: { event_record_count: 0, audit_record_count: 8 }, reason_code: null, observed_at: "2026-07-16T01:02:03Z" },
