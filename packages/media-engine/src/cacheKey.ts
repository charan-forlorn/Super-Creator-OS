...
export function normalizeCodec(c: string | null | undefined): string {
  if (!c) return "na";
...
export function proxyCacheKey(sourcePath: string, codecSignature: string): string {
...
export function thumbnailCacheKey(sourcePath: string, timeSec: number): string {
...
export function cacheFileName(kind: CacheKind, key: string): string {
 ...
 */
export function cachePath(cacheDir: string, kind: CacheKind, key: string): string {
